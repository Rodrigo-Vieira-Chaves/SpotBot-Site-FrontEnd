...
function HomePageThirdPart ()
{
    return (
        <>
            <Title id="FAQ" title="Frequently Asked Questions" className="w-full mt-24" />
            <div className="flex flex-col lg:flex-row justify-around items-center gap-12 lg:gap-28 w-full mt-16">
                <div className="flex flex-col gap-12 w-full lg:w-1/2 h-full text-center">
                    ...
                    <div className="flex flex-col gap-4 w-full h-full">
                        <Title title="In which exchange does the bot runs on?" className="w-full text-3xl" />
                ...
                <div className="flex flex-col gap-4 w-full lg:w-1/2 h-full text-center">
